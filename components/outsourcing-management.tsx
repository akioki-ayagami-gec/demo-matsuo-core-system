...
const outsourcingOrders = [
  {
    ...
    priority: "high",
    totalAmount: 450000,
    specifications: "A4カタログ 32ページ フルカラー 特殊加工",
    contactPerson: "田中部長",
    progress: 60,
  ...
  },
  {
    ...
    priority: "medium",
    totalAmount: 180000,
    specifications: "B0ポスター 100枚 フルカラー",
    contactPerson: "佐藤課長",
    progress: 100,
...
const vendors = [
  {
    id: "V001",
    name: "高品質印刷株式会社",
    specialties: ["高級印刷", "特殊加工", "小ロット対応"],
    rating: 4.8,
    activeOrders: 3,
    totalOrders: 45,
    contactPerson: "田中部長",
    phone: "089-123-4567",
    email: "tanaka@quality-print.co.jp",
  },
  {
    id: "V002",
    name: "大判印刷センター",
    specialties: ["大判印刷", "屋外広告", "短納期対応"],
    rating: 4.5,
    activeOrders: 1,
    totalOrders: 32,
    contactPerson: "佐藤課長",
    phone: "089-234-5678",
    email: "sato@large-print.co.jp",
  },
  {
    id: "V003",
    name: "製本専門工房",
    specialties: ["上製本", "特殊製本", "手作業加工"],
    rating: 4.9,
    activeOrders: 2,
    totalOrders: 28,
    contactPerson: "山田主任",
    phone: "089-345-6789",
    email: "yamada@bookbinding.co.jp",
  },
]
