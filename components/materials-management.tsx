...
const advanceProcurements = [
  ...
  {
    id: "AP002",
    material: "ステンレス線材 SUS304 φ2.0",
    quantity: 300,
    unit: "kg",
    supplier: "日鉄ステンレス株式会社",
...
const purchaseOrders = [
  {
    ...
    items: [{ material: "ピアノ線 SWP-A φ3.0", quantity: 500, unitPrice: 580 }],
  },
  {
    id: "PO002",
    ...
    items: [{ material: "硬鋼線 SWC φ2.5", quantity: 500, unitPrice: 520 }],
  },
]
